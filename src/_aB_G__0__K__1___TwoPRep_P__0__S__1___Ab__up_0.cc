...
{
const int vi = 0;
HRRPart0bra0ket0gp(inteval, &(stack[((hsi*1620+1296)*1+lsi)*1]), &(stack[((hsi*756+540)*1+lsi)*1]), &(stack[((hsi*540+0)*1+lsi)*1]),36);
}
}
}
const int hsi = 0;
const int lsi = 0;
const int vi = 0;
inteval->targets[0] = &(stack[((hsi*1620+1296)*1+lsi)*1]);
/** Number of flops = 0 */
}
