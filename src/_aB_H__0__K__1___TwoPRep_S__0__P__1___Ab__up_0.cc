...
{
const int vi = 0;
HRRPart1bra0ket0kp(inteval, &(stack[((hsi*2268+1701)*1+lsi)*1]), &(stack[((hsi*945+756)*1+lsi)*1]), &(stack[((hsi*756+0)*1+lsi)*1]),21);
}
}
}
const int hsi = 0;
const int lsi = 0;
const int vi = 0;
inteval->targets[0] = &(stack[((hsi*2268+1701)*1+lsi)*1]);
/** Number of flops = 0 */
}
