...
fp169 = 2 * inteval->oo2ze[vi];
LIBINT2_REALTYPE fp1;
fp1 = fp169 * src4[((hsi*9+8)*1+lsi)*1];
...
fp163 = inteval->roz[vi] * src3[((hsi*6+1)*1+lsi)*1];
LIBINT2_REALTYPE fp162;
fp162 = src2[((hsi*6+1)*1+lsi)*1] - fp163;
...
fp173 = inteval->roz[vi] * src3[((hsi*6+0)*1+lsi)*1];
LIBINT2_REALTYPE fp172;
fp172 = src2[((hsi*6+0)*1+lsi)*1] - fp173;
...
fp31 = fp169 * src4[((hsi*9+5)*1+lsi)*1];
...
fp36 = inteval->oo2ze[vi] * src4[((hsi*9+4)*1+lsi)*1];
...
fp74 = inteval->oo2ze[vi] * src4[((hsi*9+3)*1+lsi)*1];
...
fp58 = inteval->oo2ze[vi] * src4[((hsi*9+5)*1+lsi)*1];
...
fp64 = fp169 * src4[((hsi*9+4)*1+lsi)*1];
...
fp84 = fp169 * src4[((hsi*9+2)*1+lsi)*1];
...
fp159 = inteval->oo2ze[vi] * src4[((hsi*9+1)*1+lsi)*1];
...
fp121 = inteval->oo2ze[vi] * src4[((hsi*9+0)*1+lsi)*1];
...
fp150 = inteval->oo2ze[vi] * src4[((hsi*9+2)*1+lsi)*1];
...
fp113 = fp169 * src4[((hsi*9+1)*1+lsi)*1];
...
fp165 = inteval->WP_x[vi] * src1[((hsi*18+1)*1+lsi)*1];
LIBINT2_REALTYPE fp166;
fp166 = inteval->PA_x[vi] * src0[((hsi*18+1)*1+lsi)*1];
...
fp168 = fp169 * src4[((hsi*9+0)*1+lsi)*1];
LIBINT2_REALTYPE fp175;
fp175 = inteval->WP_x[vi] * src1[((hsi*18+0)*1+lsi)*1];
LIBINT2_REALTYPE fp176;
fp176 = inteval->PA_x[vi] * src0[((hsi*18+0)*1+lsi)*1];
