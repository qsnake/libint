...
fp22 = inteval->roe[vi] * src3[((hsi*1+0)*1+lsi)*1];
LIBINT2_REALTYPE fp21;
fp21 = src2[((hsi*1+0)*1+lsi)*1] - fp22;
LIBINT2_REALTYPE fp1;
fp1 = inteval->oo2e[vi] * fp21;
LIBINT2_REALTYPE fp3;
fp3 = inteval->WQ_z[vi] * src1[((hsi*3+2)*1+lsi)*1];
LIBINT2_REALTYPE fp4;
fp4 = inteval->QC_z[vi] * src0[((hsi*3+2)*1+lsi)*1];
...
fp20 = inteval->oo2e[vi] * fp21;
LIBINT2_REALTYPE fp24;
fp24 = inteval->WQ_x[vi] * src1[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp25;
fp25 = inteval->QC_x[vi] * src0[((hsi*3+0)*1+lsi)*1];
